    ...
    <div className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-gray-300 shadow-md w-full sticky top-0 z-50 border-b border-gray-700">
      <div className="flex py-3 px-6 md:px-24 justify-between items-center">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium">
          <Link href="/" passHref>
            <a className="text-gray-300 hover:text-cyan-500 transition duration-300 transform hover:scale-110">
              Home
            </a>
          </Link>
          <Link href="/about-us" passHref>
            <a className="text-gray-300 hover:text-cyan-400 transition duration-300 transform hover:scale-110">
              About
            </a>
          </Link>
          <Link href="/service-page" passHref>
            <a className="text-gray-300 hover:text-cyan-400 transition duration-300 transform hover:scale-110">
              Product
            </a>
          </Link>
